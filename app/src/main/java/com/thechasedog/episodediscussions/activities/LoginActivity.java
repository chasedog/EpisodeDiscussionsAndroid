...
public class LoginActivity extends AppCompatActivity {
    public static final Credentials CREDENTIALS = Credentials.installedApp("zFP5sIbzGCixiw", "https://github.com/chasedog/EpisodeDiscussionsAndroid");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] scopes = {"identity", "read", "mysubreddits", "subscribe", "save", "history", };
